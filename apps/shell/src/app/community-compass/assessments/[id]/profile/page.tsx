...
export default function ProfilePage() {
    ...
    const [exportingFormat, setExportingFormat] = React.useState<'pdf' | 'docx' | 'markdown' | null>(null);
    ...
    const handleExport = async (format: 'pdf' | 'docx' | 'markdown') => {
        ...
        if (!assessmentId) {
            toast.error('Missing assessment', 'Unable to find assessment id for export.');
            return;
        }
        ...
        try {
            ...
            anchor.href = url;
            anchor.download = `assessment-${assessmentId}.${extension}`;
            ...
            toast.error('Failed to export assessment', 'Please try again or contact support.');
        } finally {
        ...
        <div className="flex flex-col space-y-6 p-8">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <Title level={2}>Community Profile</Title>
                ...
                <Stack spacing="md">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        <GlowButton
                            ...
                            leftIcon={<FileText className="h-4 w-4" />}
                        >
                            {exportingFormat === 'docx' ? 'Exporting DOCX...' : 'Export as DOCX'}
                        </GlowButton>
                        <GlowButton
                            variant="outline"
                            ...
                            leftIcon={<FileText className="h-4 w-4" />}
                        >
                            {exportingFormat === 'markdown' ? 'Exporting Markdown...' : 'Export as Markdown'}
                        </GlowButton>
                    </div>
                </Stack>
            </GlowCard>
